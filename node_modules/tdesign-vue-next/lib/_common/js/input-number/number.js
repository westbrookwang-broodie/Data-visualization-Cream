...
function formatToNumber(num, extra) {
  ...
  if (!isUndefined(extra === null || extra === void 0 ? void 0 : extra.decimalPlaces)) {
    newNumber = largeNumberToFixed(newNumber, extra.decimalPlaces, extra.largeNumber);
  }
  var val = isLargeNumber || !isUndefined(extra === null || extra === void 0 ? void 0 : extra.decimalPlaces) ? newNumber : Number(newNumber);
...
function canInputNumber(number, largeNumber) {
  var _String$match, _String$match2;
  ...
  if (((_String$match = String(number).match(/\./g)) === null || _String$match === void 0 ? void 0 : _String$match.length) > 1) return false;
  if (((_String$match2 = String(number).match(/-/g)) === null || _String$match2 === void 0 ? void 0 : _String$match2.length) > 1) return false;
  return true;
}
...
export { add, canAddNumber, canInputNumber, canReduceNumber, formatThousandths, formatToNumber, getMaxOrMinValidateResult, getStepValue, positiveAdd, positiveSubtract, putInRangeNumber, specialCode, subtract };
