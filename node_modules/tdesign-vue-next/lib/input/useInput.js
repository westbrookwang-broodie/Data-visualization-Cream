...
function useInput(props, expose) {
  ...
  var inputValueChangeHandle = function inputValueChangeHandle(e) {
    ...
    if (props.type !== "number" && val.length > ((_innerValue$value = innerValue.value) === null || _innerValue$value === void 0 ? void 0 : _innerValue$value.length)) {
