...
var _Input = defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    return function () {
      ...
      var classes = [COMPONENT_NAME.value, props2.inputClass, (_ref3 = {}, _defineProperty(_ref3, SIZE.value[props2.size], props2.size !== "medium"), _defineProperty(_ref3, STATUS.value.disabled, disabled.value), _defineProperty(_ref3, STATUS.value.focused, focused.value), _defineProperty(_ref3, "".concat(classPrefix.value, "-is-").concat(tStatus.value), tStatus.value && tStatus.value !== "default"), _defineProperty(_ref3, "".concat(classPrefix.value, "-align-").concat(props2.align), props2.align !== "left"), _defineProperty(_ref3, "".concat(classPrefix.value, "-is-readonly"), props2.readonly), _defineProperty(_ref3, "".concat(COMPONENT_NAME.value, "--prefix"), prefixIcon || labelContent), _defineProperty(_ref3, "".concat(COMPONENT_NAME.value, "--suffix"), suffixIcon || suffixContent), _defineProperty(_ref3, "".concat(COMPONENT_NAME.value, "--focused"), focused.value), _ref3)];
