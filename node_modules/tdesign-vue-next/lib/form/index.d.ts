...
export declare const Form: {
    new (...args: any[]): {
        ...
        }>> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "data" | "disabled" | "layout" | "showErrorMessage" | "labelAlign" | "labelWidth" | "statusIcon" | "requiredMark" | "colon" | "resetType" | "preventSubmitDefault" | "submitWithWarningMessage">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
...
export declare const FormItem: {
    new (...args: any[]): {
        ...
        }>> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "label" | "status" | "for" | "showErrorMessage" | "statusIcon" | "requiredMark" | "successBorder">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
