...
export declare const Guide: {
    new (...args: any[]): {
        ...
        }>> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "zIndex" | "mode" | "modelValue" | "current" | "showOverlay" | "highlightPadding" | "hideCounter" | "hidePrev" | "hideSkip">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
