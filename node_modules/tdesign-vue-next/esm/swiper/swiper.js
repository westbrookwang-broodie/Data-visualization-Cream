...
var _Swiper = defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var swiperWrapClass = computed(function () {
      var _ref2;
      return _ref2 = {}, _defineProperty(_ref2, "".concat(prefix.value, "-swiper__wrap"), true), _defineProperty(_ref2, "".concat(prefix.value, "-swiper--inside"), navigationConfig.value.placement === "inside"), _defineProperty(_ref2, "".concat(prefix.value, "-swiper--outside"), navigationConfig.value.placement === "outside"), _defineProperty(_ref2, "".concat(prefix.value, "-swiper--vertical"), props2.direction === "vertical"), _defineProperty(_ref2, "".concat(prefix.value, "-swiper--large"), navigationConfig.value.size === "large"), _defineProperty(_ref2, "".concat(prefix.value, "-swiper--small"), navigationConfig.value.size === "small"), _ref2;
    });
    ...
    var renderNavigation = function renderNavigation() {
      ...
      return createVNode("ul", {
        "class": ["".concat(prefix.value, "-swiper__navigation"), (_ref3 = {}, _defineProperty(_ref3, "".concat(prefix.value, "-swiper__navigation-bars"), navigationConfig.value.type === "bars"), _defineProperty(_ref3, "".concat(prefix.value, "-swiper__navigation-dots"), navigationConfig.value.type === "dots"), _defineProperty(_ref3, "".concat(prefix.value, "-swiper__navigation-dots-bar"), navigationConfig.value.type === "dots-bar"), _ref3)]
    ...
    return function () {
      ...
      return createVNode("div", {
        ...
        "class": ["".concat(prefix.value, "-swiper__content"), (_ref5 = {}, _defineProperty(_ref5, "".concat(prefix.value, "-swiper-fade"), props2.animation === "fade"), _defineProperty(_ref5, "".concat(prefix.value, "-swiper-card"), props2.type === "card"), _ref5)]
      }, [createVNode("div", {
