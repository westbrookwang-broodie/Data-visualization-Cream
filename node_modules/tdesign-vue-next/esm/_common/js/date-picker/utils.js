...
import { c as commonjsGlobal } from '../../../_chunks/dep-4a432092.js';
import { c as customParseFormat } from '../../../_chunks/dep-3ff4769e.js';
...
function getWeeks(_ref4, _ref5) {
  ...
  for (i; i <= maxDays; i++) {
    ...
    daysArr.push({
      ...
      active: false,
      value: currentDay,
      disabled: isFunction(disableDate) && disableDate(currentDay) || outOfRanges(currentDay, minDate, maxDate),
