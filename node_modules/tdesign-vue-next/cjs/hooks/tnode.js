...
function handleSlots(instance, name, params) {
  ...
  var finalParams = new Function("return " + vue.h.toString())();
  if (params) {
    Object.assign(finalParams, params);
  }
  var node = (_instance$slots$camel = (_instance$slots = instance.slots)[camelCase__default["default"](name)]) === null || _instance$slots$camel === void 0 ? void 0 : _instance$slots$camel.call(_instance$slots, finalParams);
  if (node) return node;
  node = (_instance$slots$kebab = (_instance$slots2 = instance.slots)[kebabCase__default["default"](name)]) === null || _instance$slots$kebab === void 0 ? void 0 : _instance$slots$kebab.call(_instance$slots2, finalParams);
  if (node) return node;
  return null;
}
