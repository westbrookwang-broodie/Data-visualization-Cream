...
function formatToNumber(num, extra) {
  if (isNil__default["default"](num) || num === "") return num;
  if (num === "-") return 0;
  if (num[num.length - 1] === ".") {
  ...
  if (!isUndefined__default["default"](extra === null || extra === void 0 ? void 0 : extra.decimalPlaces)) {
    newNumber = _common_js_inputNumber_largeNumber.largeNumberToFixed(newNumber, extra.decimalPlaces, extra.largeNumber);
  }
  var val = isLargeNumber || !isUndefined__default["default"](extra === null || extra === void 0 ? void 0 : extra.decimalPlaces) ? newNumber : Number(newNumber);
...
function canInputNumber(number, largeNumber) {
  ...
  if (!number && isString__default["default"](number)) return true;
