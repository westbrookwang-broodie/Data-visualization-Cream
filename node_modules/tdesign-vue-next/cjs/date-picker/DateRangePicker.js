...
require('../_chunks/dep-361d6e59.js');
  ...
  setup: function setup(props2, _ref) {
    ...
    vue.watch(popupVisible, function (visible) {
      if (visible) {
        ...
        time.value = _common_js_datePicker_format.formatTime(value.value || [dayjs__default["default"]().format(formatRef.value.timeFormat), dayjs__default["default"]().format(formatRef.value.timeFormat)], formatRef.value.format, formatRef.value.timeFormat, props2.defaultTime);
        if (!value.value.length) {
          var _initYearMonthTime = _common_js_datePicker_format.initYearMonthTime({
              value: value.value,
              mode: props2.mode,
              format: formatRef.value.format,
              enableTimePicker: props2.enableTimePicker
    ...
    function onPresetClick(preset, context) {
      ...
      if (!isArray__default["default"](presetValue)) {
        ...
        popupVisible.value = false;
        (_props2$onPresetClick = props2.onPresetClick) === null || _props2$onPresetClick === void 0 ? void 0 : _props2$onPresetClick.call(props2, context);
      }
    }
