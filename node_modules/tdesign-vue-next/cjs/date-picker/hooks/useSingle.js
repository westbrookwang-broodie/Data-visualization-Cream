...
function useSingle(props) {
  ...
  var inputProps = vue.computed(function () {
    return _objectSpread(_objectSpread({}, props.inputProps), {}, {
      ...
      onChange: function onChange(val) {
        ...
        var newMonth = _common_js_datePicker_format.parseToDayjs(val, formatRef.value.format).month();
        var newYear = _common_js_datePicker_format.parseToDayjs(val, formatRef.value.format).year();
        var newTime = _common_js_datePicker_format.formatTime(val, formatRef.value.format, formatRef.value.timeFormat, props.defaultTime);
  ...
  vue.watch(value, function (value2) {
    ...
    if (!_common_js_datePicker_format.isValidDate(value2, formatRef.value.format)) return;
    inputValue.value = _common_js_datePicker_format.formatDate(value2, {
      format: formatRef.value.format
    });
  });
  return {
