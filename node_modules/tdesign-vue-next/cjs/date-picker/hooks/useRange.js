    ...
    return _objectSpread(_objectSpread({}, props.rangeInputProps), {}, {
      ...
      onChange: function onChange(newVal, _ref5) {
        ...
        newVal.forEach(function (v) {
          newYear.push(_common_js_datePicker_format.parseToDayjs(v, formatRef.value.format).year());
          newMonth.push(_common_js_datePicker_format.parseToDayjs(v, formatRef.value.format).month());
          newTime.push(_common_js_datePicker_format.parseToDayjs(v, formatRef.value.format).format(formatRef.value.timeFormat));
        });
        year.value = newYear;
