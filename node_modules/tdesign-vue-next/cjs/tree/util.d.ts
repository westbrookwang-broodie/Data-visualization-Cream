...
export declare const getStoreConfig: (props: TdTreeProps) => Pick<TdTreeProps<import("..").TreeOptionData<string | number>>, "filter" | "keys" | "load" | "draggable" | "lazy" | "disabled" | "expandMutex" | "valueMode" | "checkable" | "activable" | "activeMultiple" | "checkStrictly" | "expandAll" | "expandLevel" | "expandParent">;
