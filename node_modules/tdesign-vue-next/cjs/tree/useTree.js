...
function useTree(props) {
  ...
  var updateExpanded = function updateExpanded() {
    ...
    if (isArray__default["default"](innerExpanded.value)) {
  ...
  var init = function init() {
    ...
    if (!isArray__default["default"](options)) {
      options = [];
    }
    store.append(options);
    store.refreshNodes();
    if (isArray__default["default"](innerChecked.value)) {
      store.setChecked(innerChecked.value);
    }
    updateExpanded();
    if (isArray__default["default"](innerActived.value)) {
