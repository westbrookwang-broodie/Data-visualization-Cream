...
var _Input = vue.defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    return function () {
      var _ref3, _compositionValue$val, _inputValue$value;
      ...
      var classes = [COMPONENT_NAME.value, props2.inputClass, (_ref3 = {}, _defineProperty__default["default"](_ref3, SIZE.value[props2.size], props2.size !== "medium"), _defineProperty__default["default"](_ref3, STATUS.value.disabled, disabled.value), _defineProperty__default["default"](_ref3, STATUS.value.focused, focused.value), _defineProperty__default["default"](_ref3, "".concat(classPrefix.value, "-is-").concat(tStatus.value), tStatus.value && tStatus.value !== "default"), _defineProperty__default["default"](_ref3, "".concat(classPrefix.value, "-align-").concat(props2.align), props2.align !== "left"), _defineProperty__default["default"](_ref3, "".concat(classPrefix.value, "-is-readonly"), props2.readonly), _defineProperty__default["default"](_ref3, "".concat(COMPONENT_NAME.value, "--prefix"), prefixIcon || labelContent), _defineProperty__default["default"](_ref3, "".concat(COMPONENT_NAME.value, "--suffix"), suffixIcon || suffixContent), _defineProperty__default["default"](_ref3, "".concat(COMPONENT_NAME.value, "--focused"), focused.value), _ref3)];
