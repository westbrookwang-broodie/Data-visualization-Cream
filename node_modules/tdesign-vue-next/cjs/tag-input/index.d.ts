...
export declare const TagInput: {
    new (...args: any[]): {
        ...
        }>> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "value" | "disabled" | "size" | "readonly" | "placeholder" | "modelValue" | "defaultValue" | "autoWidth" | "clearable" | "inputValue" | "excessTagsDisplayType" | "defaultInputValue" | "dragSort" | "minCollapsedNum">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
