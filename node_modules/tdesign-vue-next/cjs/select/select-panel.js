...
var SelectPanel = vue.defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    var renderPanel = function renderPanel(options, extraStyle) {
      ...
      }), !isEmpty.value && !props.loading && renderOptionsContent(options), renderTNodeJSX("panelBottomContent")]);
    };
    return {
  ...
  render: function render() {
    return this.isVirtual ? vue.createVNode("div", null, [vue.createVNode("div", {
      "style": this.cursorStyle
    }, null), this.renderPanel(this.visibleData, this.panelStyle)]) : this.renderPanel(this.displayOptions);
  }
});
