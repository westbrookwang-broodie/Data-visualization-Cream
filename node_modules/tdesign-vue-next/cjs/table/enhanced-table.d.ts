...
declare const _default: import("vue").DefineComponent<{
    ...
    expandIcon: {
        type: import("vue").PropType<boolean | ((h: typeof import("vue").h, props: import("./type").ExpandArrowRenderParams<TableRowData>) => import("..").SlotReturnValue)>;
        default: boolean | ((h: typeof import("vue").h, props: import("./type").ExpandArrowRenderParams<TableRowData>) => import("..").SlotReturnValue);
    };
    expandOnRowClick: BooleanConstructor;
    expandedRow: {
        type: import("vue").PropType<(h: typeof import("vue").h, props: import("./type").TableExpandedRowParams<TableRowData>) => import("..").SlotReturnValue>;
    };
    expandedRowKeys: {
        type: import("vue").PropType<(string | number)[]>;
        default: any;
    ...
    cellEmptyContent: {
        type: import("vue").PropType<string | ((h: typeof import("vue").h, props: import("./type").BaseTableCellParams<TableRowData>) => import("..").SlotReturnValue)>;
    };
    data: {
    ...
    expandIcon: boolean | ((h: typeof import("vue").h, props: import("./type").ExpandArrowRenderParams<TableRowData>) => import("..").SlotReturnValue);
