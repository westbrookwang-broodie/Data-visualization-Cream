...
function useDragSort(props, context) {
  ...
  var registerRowDragEvent = function registerRowDragEvent(element) {
    ...
    if (isRowDraggable.value) {
      dragRowInstanceTmp = new Sortable__default["default"](dragContainer, _objectSpread({}, baseOptions));
    } else {
      dragRowInstanceTmp = new Sortable__default["default"](dragContainer, _objectSpread(_objectSpread({}, baseOptions), {}, {
    ...
    var options = _objectSpread({
      ...
      onEnd: function onEnd(evt) {
        ...
        if (recover) {
          ...
          (_dragColInstanceTmp2 = dragColInstanceTmp) === null || _dragColInstanceTmp2 === void 0 ? void 0 : _dragColInstanceTmp2.sort(_toConsumableArray__default["default"](lastColList.value));
        }
