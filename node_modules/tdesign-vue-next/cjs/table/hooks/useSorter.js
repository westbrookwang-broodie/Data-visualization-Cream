...
function useSorter(props, _ref) {
  ...
  vue.watch(function () {
    ...
    var previousVal = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
    if (val.map(function (t) {
      return get__default["default"](t, props.rowKey);
    }).join() !== previousVal.map(function (t) {
      return get__default["default"](t, props.rowKey);
    }).join()) {
