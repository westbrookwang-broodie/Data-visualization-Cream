...
var _Submenu = vue.defineComponent({
  ...
  setup: function setup(props2, ctx) {
    ...
    var popupClass = vue.computed(function () {
      return ["".concat(classPrefix.value, "-menu__popup"), "".concat(classPrefix.value, "-is-").concat(isHead ? "horizontal" : "vertical"), _defineProperty__default["default"]({}, "".concat(classPrefix.value, "-is-opened"), popupVisible.value), "narrow-scrollbar"];
    });
  ...
  methods: {
    renderPopup: function renderPopup(triggerElement) {
      ...
      var overlayInnerStyle = this.isNested && this.isHead ? {
        marginLeft: "0px"
      } : _defineProperty__default["default"]({}, "margin-top': ", "12px");
