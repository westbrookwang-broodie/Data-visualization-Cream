...
export declare const RangeInput: {
    new (...args: any[]): {
        ...
        }>> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "value" | "disabled" | "size" | "readonly" | "status" | "separator" | "modelValue" | "defaultValue" | "clearable" | "showClearIconOnEmpty">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
...
export declare const RangeInputPopup: {
    new (...args: any[]): {
        ...
        }>> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "disabled" | "readonly" | "status" | "autoWidth" | "inputValue" | "popupVisible">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
