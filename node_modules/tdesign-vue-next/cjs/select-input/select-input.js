...
var _SelectInput = vue.defineComponent({
  ...
  setup: function setup(props2, context) {
    ...
    var classes = vue.computed(function () {
      ...
      return ["".concat(NAME_CLASS.value), (_ref = {}, _defineProperty__default["default"](_ref, BASE_CLASS_MULTIPLE.value, multiple.value), _defineProperty__default["default"](_ref, BASE_CLASS_BORDERLESS.value, borderless.value), _defineProperty__default["default"](_ref, BASE_CLASS_POPUP_VISIBLE.value, (_popupVisible$value = popupVisible.value) !== null && _popupVisible$value !== void 0 ? _popupVisible$value : innerPopupVisible.value), _defineProperty__default["default"](_ref, BASE_CLASS_EMPTY.value, value.value instanceof Array ? !value.value.length : !value.value), _ref)];
    });
    return {
