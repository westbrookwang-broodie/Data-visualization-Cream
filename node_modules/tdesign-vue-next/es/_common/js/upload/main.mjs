...
import { a as _arrayWithHoles, b as _nonIterableRest, _ as _slicedToArray } from '../../../_chunks/dep-7856a613.mjs';
import { a as _iterableToArray } from '../../../_chunks/dep-89c2d338.mjs';
import { a as _unsupportedIterableToArray } from '../../../_chunks/dep-e827c721.mjs';
    ...
    if (requestMethod) {
      requestMethod(params.multiple ? toUploadFiles : toUploadFiles[0]).then(function (res) {
        ...
        var _res$response = res.response,
          response = _res$response === void 0 ? {} : _res$response;
        if (res.status === "fail") {
