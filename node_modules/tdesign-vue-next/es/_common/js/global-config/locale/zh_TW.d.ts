...
declare const _default: {
    readonly pagination: {
        readonly itemsPerPage: "{size} 條/頁";
        readonly jumpTo: "跳至";
        readonly page: "頁";
    ...
    readonly calendar: {
        ...
        readonly hideWeekend: "隱藏周末";
        readonly showWeekend: "顯示周末";
        readonly today: "今天";
    ...
    readonly table: {
        readonly empty: "暫無數據";
        readonly loadingText: "正在加載中，請稍後";
        readonly loadingMoreText: "點擊加載更多";
        ...
        readonly columnConfigDescriptionText: "請選擇需要在表格中顯示的數據列";
        readonly confirmText: "確認";
        readonly cancelText: "取消";
        readonly resetText: "重置";
        readonly selectAllText: "全選";
        readonly searchResultText: "搜索\"{result}\"，找到{count}條結果";
    };
    readonly select: {
        readonly empty: "暫無數據";
        readonly loadingText: "加載中";
    ...
    readonly form: {
        readonly errorMessage: {
            ...
            readonly boolean: "${name}數據類型必須是布爾類型";
    ...
    readonly anchor: {
        readonly copySuccessText: "鏈接複製成功";
        readonly copyText: "複製鏈接";
    };
    ...
    readonly image: {
        ...
        readonly loadingText: "圖片加載中";
    };
    readonly imageViewer: {
        readonly errorText: "圖片加載失敗，可嘗試重新加載";
