...
import { _ as _classCallCheck, a as _createClass } from '../../../_chunks/dep-ff4c6fe3.mjs';
import { _ as _defineProperty } from '../../../_chunks/dep-9ddd4050.mjs';
import { i as isNull_1 } from '../../../_chunks/dep-e442c09f.mjs';
...
import { t as toString_1 } from '../../../_chunks/dep-7c35655e.mjs';
...
var TreeNode = /*#__PURE__*/function () {
  function TreeNode(tree, data, parent) {
    ...
    var spec = _objectSpread(_objectSpread({}, defaultStatus), data);
    var children = spec[propChildren];
    this.set(spec);
    this.label = spec[propLabel] || "";
    this.value = isNil_1(spec[propValue]) ? this[privateKey] : spec[propValue];
      ...
      if (this.isActivable()) {
        if (actived) {
          ...
          prevKeys.forEach(function (value) {
            ...
            node === null || node === void 0 ? void 0 : node.update();
          });
...
export { TreeNode, TreeNode as default, defaultStatus, privateKey };
