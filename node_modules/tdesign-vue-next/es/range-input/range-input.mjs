  ...
  setup: function setup(props2, _ref) {
    ...
    return function () {
      ...
      return createVNode("div", {
        "class": [COMPONENT_NAME.value, (_ref5 = {}, _defineProperty(_ref5, SIZE.value[props2.size], props2.size !== "medium"), _defineProperty(_ref5, STATUS.value.disabled, disabled.value), _defineProperty(_ref5, STATUS.value.focused, focused.value), _defineProperty(_ref5, STATUS.value.success, props2.status === "success"), _defineProperty(_ref5, STATUS.value.warning, props2.status === "warning"), _defineProperty(_ref5, STATUS.value.error, props2.status === "error"), _defineProperty(_ref5, "".concat(COMPONENT_NAME.value, "--prefix"), prefixIconContent || labelContent), _defineProperty(_ref5, "".concat(COMPONENT_NAME.value, "--suffix"), suffixContent || suffixIconContent), _ref5)],
        ...
        "onClick": handleClear
      }, null) : suffixIconContent])]), tips && createVNode("div", {
