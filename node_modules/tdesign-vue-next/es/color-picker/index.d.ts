...
export declare const ColorPickerPanel: {
    new (...args: any[]): {
        ...
        }>> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "value" | "disabled" | "multiple" | "format" | "modelValue" | "defaultValue" | "clearable" | "closeBtn" | "colorModes" | "recentColors" | "defaultRecentColors" | "enableAlpha" | "showPrimaryColorPreview">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
