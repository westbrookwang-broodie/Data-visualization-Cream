...
.t-head-menu .t-menu__popup {
  top: calc(var(--td-comp-size-m) + 12px);
  left: 0;
  min-width: 100%;
...
.t-default-menu .t-menu__sub.t-is-opened {
  max-height: calc(100vh - var(--td-comp-size-xxxl) * 2);
}
...
.t-default-menu .t-menu__popup .t-menu__item,
.t-default-menu .t-menu__popup .t-submenu {
  margin: var(--td-comp-margin-xxs) 0 0 0;
}
.t-default-menu .t-menu__popup .t-menu__item:first-child,
.t-default-menu .t-menu__popup .t-submenu:first-child {
  margin-top: 0;
}
...
.t-menu__popup.t-is-opened .t-menu__popup {
  top: calc(0px - var(--td-pop-padding-m));
  left: 100%;
  overflow-x: hidden;
  overflow-y: auto;
}
...
.t-menu__popup .t-menu__item:first-child,
.t-menu__popup .t-submenu:first-child {
  margin-top: 0;
}
